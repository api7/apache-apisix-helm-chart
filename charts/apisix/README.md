...
| apisix.image.repository | string | `"asia-east2-docker.pkg.dev/molten-verve-356604/api7/api7-gateway"` | Apache APISIX image repository |
| apisix.image.tag | string | `"3.2.3.1"` | Apache APISIX image tag Overrides the image tag whose default is the chart appVersion. |
